...
**Answer:** JSX is a syntax that allows us to write HTML-like code inside JavaScript or TypeScript.
...
**Answer:** Props are used to pass data from a parent component to a child component. Props are read-only.
...
**Answer:** `useState` is a React Hook used to store and update data inside a component.
...
**Answer:** `useEffect` is a React Hook used for handling side effects.
...
**Answer:** React uses a `key` to identify individual items in a list.
...
**Answer:** Data can be passed from a parent to a child using props.
...
🚀 **Live Website:** [Dev Stack](https://dev-stack-builder-2026.netlify.app/)
