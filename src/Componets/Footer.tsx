      ...
      <div className="max-w-7xl mx-auto px-4 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-sm text-gray-400 leading-5 mt-4 max-w-xs">
        ...
        <div className="border-t border-gray-100 mt-12 pt-7 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-400">
